...
export const GetProviders = async () => axios.get(`${baseURL}/v1/provedores/`);
export const GetProvidersMovies = async (id) => axios.get(`${baseURL}/v1/peliculas_provedores/?provedor_id=${id}`);
export const GetFavoriteProviders = async (id) => axios.get(`${baseURL}/v1/provedores_f/?usuario_id=${id}`);
export const AddFavoriteProviders = async (datos) => axios.post(`${baseURL}/v1/provedores_f/`, datos);
export const DelFavoriteProviders = async (id) => axios.delete(`${baseURL}/v1/provedores_f/${id}/`);
...
export const GetRecomendationProviders = async (id,idg) => axios.get(`${baseURL}/recomendacionesByProvedores/${id}/?provedor_id=${idg}`);
